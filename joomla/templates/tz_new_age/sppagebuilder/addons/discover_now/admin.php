...
SpAddonsConfig::addonConfig(
	array(
		'type'=>'content',
		'addon_name'=>'sp_discover_now',
		'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_DISCOVER_NOW'),
		'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_DISCOVER_NOW_DESC'),
		'category'=>'Content',
		'attr'=>array(
			'general' => array(
				...
				'scroll_to_id'=>array(
					'type'=>'text',
					'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_SCROLL_TO_ID'),
					'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_SCROLL_TO_ID_DESC'),
					'std'=> ''
				),
