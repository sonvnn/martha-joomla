...
<?php if (isset($images->image_intro) && !empty($images->image_intro)) : ?>
	...
	<?php if ($params->get('link_titles') && $params->get('access-view')) : ?>
		...
		<?php if ($images->image_intro_caption) : ?>
			<?php echo 'class="caption card-img-top"' . ' title="' . htmlspecialchars($images->image_intro_caption) . '"'; ?>
        <?php else: ?>
			<?php echo 'class="card-img-top"'; ?>
		<?php endif; ?>
	...
	<?php else : ?><img
		<?php if ($images->image_intro_caption) : ?>
			<?php echo 'class="caption card-img-top"' . ' title="' . htmlspecialchars($images->image_intro_caption, ENT_COMPAT, 'UTF-8') . '"'; ?>
		<?php else: ?>
			<?php echo 'class="card-img-top"'; ?>
		<?php endif; ?>
