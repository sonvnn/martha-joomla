...
$document->addStyleSheet('templates/tz_new_age/assets/owl.carousel.min.css');
$document->addStyleSheet('templates/tz_new_age/assets/owl.theme.default.min.css');
$document->addScript('templates/tz_new_age/assets/owl.carousel.min.js');
?>
