	...
	<div class="ezb-grids">
		<?php foreach ($posts as $post) { ?>
			<div class="ezb-grid" style="width: <?php echo 100 / $params->get('columns');?>%">
				<a class="ezb-card" href="<?php echo $post->getPermalink(); ?>" title="<?php echo $post->getTitle(); ?>" style="background-image: url('<?php echo $post->getImage('original', true, true, true);?>');">
