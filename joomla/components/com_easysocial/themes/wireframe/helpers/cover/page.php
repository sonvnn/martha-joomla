...
<div class="es-profile-header t-lg-mb--lg">
	<div class="es-profile-header__hd with-cover">
		...
		<div class="es-profile-header__avatar-wrap es-flyout <?php echo $this->config->get('layout.avatar.style') == 'rounded' ? 'o-avatar-status--rounded' : '';?>" data-avatar>
			<a href="<?php echo $page->getAvatarPhoto() ? 'javascript:void(0);' : $page->getPermalink();?>"<?php echo $page->getAvatarPhoto() && $showPhotoPopup ? 'data-es-photo="' . $page->getAvatarPhoto()->id . '"' : '';?> class="<?php echo $this->config->get('layout.avatar.style') == 'rounded' ? 'o-avatar--rounded' : '';?>">
