...
<div class="es-profile-header t-lg-mb--lg">
	<div class="es-profile-header__hd with-cover">
		...
		<div class="es-profile-header__avatar-wrap es-flyout <?php echo $this->config->get('layout.avatar.style') == 'rounded' ? 'o-avatar-status--rounded' : '';?>" data-avatar>
			<a href="<?php echo $group->getAvatarPhoto() ? 'javascript:void(0);' : $group->getPermalink();?>"<?php echo $group->getAvatarPhoto() && $showPhotoPopup ? 'data-es-photo="' . $group->getAvatarPhoto()->id . '"' : '';?> class="<?php echo $this->config->get('layout.avatar.style') == 'rounded' ? 'o-avatar--rounded' : '';?>">
