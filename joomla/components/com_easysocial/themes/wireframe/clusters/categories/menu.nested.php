...
<ul class="o-tabs o-tabs--stacked dl-submenu">
	...
	<li class="o-tabs__item has-notice <?php echo $activeCategory && $activeCategory->id == $child->id ? 'active' : '';?>" data-filter-item data-type="category" data-id="<?php echo $child->id;?>">
		...
		<?php } ?>
		<span class="o-tabs__bubble" data-counter="<?php echo $child->getTotalCluster($type, $cluster);?>">
			<?php echo $child->getTotalCluster($type);?>
		</span>
		<div class="o-loader o-loader--sm"></div>
		<?php if (!empty($child->childs)) { ?>
			<?php echo $this->includeTemplate('site/clusters/categories/menu.nested', array('category' => $child, 'type' => $type, 'activeCategory' => $activeCategory)); ?>
		<?php } ?>
	</li>
	<?php } ?>
</ul>