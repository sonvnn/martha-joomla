		...
		<div class="es-card__ft es-card--border">
			<div class="es-card__meta">
				<ol class="g-list-inline g-list-inline--delimited">
					...
					<li>
						<a href="<?php echo $event->getAddressLink(); ?>" target="_blank"><i class="fa fa-map-marker"></i>&nbsp; <?php echo JString::substr($event->address, 0, 15) . JText::_('COM_EASYSOCIAL_ELLIPSES'); ?></a>
					</li>
					<?php } ?>
