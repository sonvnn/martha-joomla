...
<?php if (($post->image || (!$post->image && $this->entryParams->get('post_image_placeholder', false))) && $this->entryParams->get('post_image', true)) { ?>
	...
	<!-- <div class="uk-text-center uk-margin-top" property="image" typeof="ImageObject">
		<a href="<?php echo $post->getPermalink();?>">
			<img uk-img="" property="url" alt="" src="<?php echo $post->getImage($this->config->get('cover_size_entry', 'large'), true, false, false);?>">
		</a>
	</div> -->
	<div class="uk-text-center uk-margin-top" property="image" typeof="ImageObject">
		<a href="<?php echo $post->getPermalink();?>">
			<div class="uk-height-medium uk-flex uk-flex-center uk-flex-middle uk-background-cover uk-light" data-src="<?php echo $post->getImage($this->config->get('cover_size_entry', 'large'), true, false, false);?>" uk-img>
				<span><?php echo $this->escape($post->getImageCaption());?></span>
			</div>
		</a>
	</div>

	<div class="uk-hidden eb-image eb-post-thumb<?php echo $this->config->get('cover_width_entry_full') ? " is-full" : " is-" . $this->config->get('cover_alignment_entry')?>" data-eb-entry-cover>
