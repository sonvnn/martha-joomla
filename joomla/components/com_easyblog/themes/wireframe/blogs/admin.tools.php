...
?>
<?php if (EB::isSiteAdmin() || ($post->isMine() && !$post->hasRevisionWaitingForApproval()) || ($post->isMine() && $this->acl->get('publish_entry')) || ($post->isMine() && $this->acl->get('delete_entry')) || $this->acl->get('feature_entry') || $this->acl->get('moderate_entry') || $post->canFavourite()) { ?>
<div class="eb-post-admin">
	...
	<?php if (EB::isSiteAdmin() || (($post->isMine() ||$post->isTeamBlogAdmin()) && !$post->hasRevisionWaitingForApproval())
			|| (($post->isMine() || $post->isTeamBlogAdmin())  && $this->acl->get('publish_entry'))
			|| (($post->isMine() || $post->isTeamBlogAdmin()) && $this->acl->get('delete_entry'))
		...
		<div class="eb-post-admin__item">
			<div class="dropdown_" data-blog-tools>
				...
				<ul class="dropdown-menu reset-list" role="menu" aria-labelledby="post-<?php echo $post->id;?>">
					...
					<?php if (EB::isSiteAdmin() || $this->acl->get('moderate_entry') || (($post->isMine() || $post->isTeamBlogAdmin()) && !$post->hasRevisionWaitingForApproval())) { ?>
					<li>
