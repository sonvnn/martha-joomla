        ...
        <div class="card-body d-flex align-items-center">
            ...
            <div class="media-body">
                ...
                <ul class="list-inline muted text-muted ">
                    ...
                    <?php } ?>
                    <?php if($params -> get('show_cat_email_user', 1) && $author -> email){?>
                    <li class="list-inline-item email hasTooltip" data-toggle="tooltip" title="<?php
                    echo JText::_('TP_STYLE_ARTGALLERY_EMAIL');?>">
                ...
                <?php if($params -> get('show_cat_social_link_user', 1) && (!empty($author -> twitter)
                    ...
                    <ul class="list-inline social muted">
                        <?php if($author -> twitter){?>
                            <li class="list-inline-item">
                                <a href="<?php echo $author -> twitter; ?>" class="hasTooltip" title="<?php
                                echo JText::_('PLG_USER_PROFILE_TWITTER');
                                ?>" data-toggle="tooltip" target="_blank"><i class="tp tp-twitter" aria-hidden="true"></i></a>
                            </li>
                        <?php } ?>
                        <?php if($author -> facebook){?>
                            <li class="list-inline-item">
                                <a href="<?php echo $author -> facebook; ?>"class="hasTooltip" title="<?php
                                echo JText::_('PLG_USER_PROFILE_FACEBOOK');
                                ?>" data-toggle="tooltip" target="_blank"><i class="tp tp-facebook-official" aria-hidden="true"></i></a>
                            </li>
                        <?php } ?>
                        <?php if($author -> instagram){?>
                            <li class="list-inline-item">
                                <a href="<?php echo $author -> instagram; ?>"class="hasTooltip" title="<?php
                                echo JText::_('PLG_USER_PROFILE_INSTAGRAM');
                                ?>" data-toggle="tooltip" target="_blank"><i class="tp tp-instagram" aria-hidden="true"></i></a>
                            </li>
                        <?php } ?>
