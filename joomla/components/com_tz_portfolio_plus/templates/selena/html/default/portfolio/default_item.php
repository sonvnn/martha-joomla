...
?>
    <?php foreach($this -> items as $i => $item):
        ...
        $type           =   $params -> get('tpl_selena_type','standard');
        $title_pos      =   $params -> get('tpl_selena_title_position','middle');
    ?>
<div id="tzelement<?php echo $item -> id;?>"
    ...
    <div class="TzInner">
        <div class="tpThumbnail <?php echo $title_pos; ?>"<?php echo trim($tplParams->get('padding')) ? 'style="top:'.$tplParams->get('padding').';left:'.$tplParams->get('padding').';right:'.$tplParams->get('padding').';bottom:'.$tplParams->get('padding').';"' : ''; ?>>
            ...
            if(!isset($item -> mediatypes) || (isset($item -> mediatypes) && !in_array($item -> type,$item -> mediatypes))):
                ...
                <div class="TzPortfolioDescription">
                    ...
                    if ($params->get('show_cat_print_icon', 0) || $params->get('show_cat_email_icon', 0)
                        ...
                        <div class="tp-item-tools mb-3">
                            <ul class="nav">
                                <?php if ($params->get('show_cat_print_icon', 0)) : ?>
                                    <li class="nav-item"> <?php echo JHtml::_('icon.print_popup', $item, $params); ?> </li>
                                <?php endif; ?>
                                <?php if ($params->get('show_cat_email_icon', 0)) : ?>
                                    <li class="nav-item"> <?php echo JHtml::_('icon.email', $item, $params); ?> </li>
                                <?php endif; ?>

                                <?php if ($params -> get('access-edit')) : ?>
                                    <li class="nav-item"> <?php echo JHtml::_('icon.edit', $item, $params); ?> </li>
                                <?php endif; ?>
                            </ul>
                        </div>
                    <?php endif;
                    ...
                    <?php if($params -> get('show_cat_readmore',1)):?>
                        <a class="btn btn-light" href="<?php echo $item ->link; ?>">
            ...
            <a href="<?php echo $item ->link; ?>" title="<?php echo $this->escape($item -> title); ?>" itemprop="url"><div class="overlay"></div></a>
            <?php
