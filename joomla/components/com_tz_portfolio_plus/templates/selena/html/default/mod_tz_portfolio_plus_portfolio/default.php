...
if ($list):
    ?>
    <div id="TzContent<?php echo $module->id; ?>" class="tz_portfolio_plus_portfolio<?php echo $moduleclass_sfx;?> tplSelena TzContent tpp-bootstrap">
        ...
        <div id="portfolio<?php echo $module->id; ?>" class="masonry row " style="margin: 0 -<?php echo $tplParams->get('padding'); ?>">
            <?php foreach ($list as $i => $item) : ?>
                ...
                ?>
                <div class="element <?php echo implode(' ', $item_filter).' '.$type.$tzItemFeatureClass ?>"
                                ...
                                <div class="TzPortfolioDescription">
                                    ...
                                    if($item -> params -> get('show_readmore',1)){
                                        ...
                                        <a href="<?php echo $item->link?>"
                                           class="btn btn-light"><?php echo $item -> params -> get('readmore_text','Read More');?></a>
                                    <?php }
                                    ?>
                                </div>
                            <?php }
