...
if($controller = TZ_Portfolio_Plus_AddOnControllerLegacy::getInstance('TZ_Portfolio_Plus_AddOn_Flipbook_Gallery'
	, array('base_path' => COM_TZ_PORTFOLIO_PLUS_ADDON_PATH
		.DIRECTORY_SEPARATOR.'mediatype'
		.DIRECTORY_SEPARATOR.'flipbook_gallery'.DIRECTORY_SEPARATOR.'admin'))) {
