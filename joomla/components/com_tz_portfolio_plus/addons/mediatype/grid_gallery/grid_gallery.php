...
JLoader::import('grid_gallery',__DIR__.DIRECTORY_SEPARATOR.'libraries');

class PlgTZ_Portfolio_PlusMediaTypeGrid_Gallery extends TZ_Portfolio_PlusPlugin
{
        ...
        if($article){
            if($media = $article -> media){
                if(isset($media -> grid_gallery)){
                    ...
                    $this -> setVariable('grid_gallery', $grid_gallery);
                }
            }
