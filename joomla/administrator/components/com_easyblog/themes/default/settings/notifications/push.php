	...
	<div class="col-lg-6">
		<div class="panel">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<?php echo $this->html('form.label', 'COM_EB_ONESIGNAL_RENDER_MANIFEST', 'onesignal_manifest'); ?>
					
					<div class="col-md-7">
						<?php echo $this->html('form.toggler', 'onesignal_manifest', $this->config->get('onesignal_manifest')); ?>
					</div>
				</div>
