	...
	public function save($key = null, $urlVar = null) {
		...
		switch ($task) {
			case 'apply':
				...
				$output['preview_url'] = SppagebuilderHelper::generateSefUrl($siteRouter, $preview_link);
				$output['frontend_editor_url'] = SppagebuilderHelper::generateSefUrl($siteRouter, $front_link);
