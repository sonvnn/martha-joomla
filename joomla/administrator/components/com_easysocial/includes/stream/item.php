...
class SocialStreamItem extends EasySocial
{
	 ...
	 * @access	public
	 */
	public function formatMentions($content, $view, $restFormat = false, $debug = false)
	{
	...
	public function toExportData($viewer)
	{
		...
		$item->mood = $this->mood ? $this->mood->subject : false;
	...
	public function formatStreamContent($viewer)
	{
		...
		$formattedContent = $this->formatMentions($rawContent, 'stream', true, true);
		...
		$contentObject = $this->formatStreamObjects($viewer, $formattedContent);

		$streamContent = new stdClass();
		$streamContent->raw = $rawContent;
		$streamContent->formatted = $formattedContent;
		$streamContent->object = $contentObject;
