					...
					?>
						...
						<?php if ($key == 'profiles') { ?>
							<div class="form-group">
								...
								<div class="col-md-6">
									<select class="o-o-form-control input-sm privacySelection" name="params[robots]">
										<option value="<?php echo SOCIAL_PROFILE_ROBOTS_INHERIT;?>" <?php echo $param->get('robots') == SOCIAL_PROFILE_ROBOTS_INHERIT ? ' selected="selected"' : '';?>><?php echo JText::_('COM_ES_PROFILE_ROBOTS_INHERIT'); ?></option>
										<option value="<?php echo SOCIAL_PROFILE_ROBOTS_INDEX;?>" <?php echo $param->get('robots') == SOCIAL_PROFILE_ROBOTS_INDEX ? ' selected="selected"' : '';?>><?php echo JText::_('COM_ES_PROFILE_ROBOTS_INDEX'); ?></option>
										<option value="<?php echo SOCIAL_PROFILE_ROBOTS_NOINDEX;?>" <?php echo $param->get('robots') == SOCIAL_PROFILE_ROBOTS_NOINDEX ? ' selected="selected"' : '';?>><?php echo JText::_('COM_ES_PROFILE_ROBOTS_NOINDEX'); ?></option>
									</select>
								</div>
							</div>
						<?php } ?>
