	...
	<div class="col-md-6">
		<div class="panel">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<?php echo $this->html('panel.label', 'COM_ES_STREAM_SETTINGS_ENABLE_GIPHY'); ?>

					<div class="col-md-7">
						<?php echo $this->html('form.toggler', 'stream.story.giphy', $this->config->get('stream.story.giphy')); ?>
					</div>
				</div>
			</div>
		</div>
