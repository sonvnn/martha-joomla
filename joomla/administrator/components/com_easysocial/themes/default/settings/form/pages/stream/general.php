	...
	<div class="col-md-6">
		<div class="panel">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<?php echo $this->html('panel.label', 'COM_ES_STREAM_SETTING_COPY_LINK'); ?>

					<div class="col-md-7">
						<?php echo $this->html('form.toggler', 'stream.copylink.enabled', $this->config->get('stream.copylink.enabled')); ?>
					</div>
				</div>
			</div>
		</div>
